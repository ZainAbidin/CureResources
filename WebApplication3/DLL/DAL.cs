...
namespace DAL
{
    ...
    public class Dal
    {
        ...
        public int signUp(string username, string confirmPassword, string Fname, string Lname, string city, string country, string employeeCode, string Age)
        {
            using (SqlConnection con = new SqlConnection(CS))
            {
        ...
        public DataTable spActivity(string username)
        {
            using (SqlConnection conn = new SqlConnection(CS))
            {
        ...
        public void spSendIm(string username, string message)
        {
            using (SqlConnection conn = new SqlConnection(CS))
            {
        ...
        public DataTable GetRow(string username)
        {
            using (SqlConnection con = new SqlConnection(CS))
            {
        ...
        public string EmployeeReadIM(string username)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(CS))
